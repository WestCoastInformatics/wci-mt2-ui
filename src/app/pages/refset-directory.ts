      ...
      subscribe({
        next: ([results, versionResults, editionResults, organizationResults]) => {
          ...
          this.columnDefs = [
            ...
            { field: 'downloadable', colId: 'actions', headerName: '', width: 120, cellClass: 'rt2-directory-column-actions', cellRenderer: 'templateRenderer', cellRendererParams: { template: this.actionSection }, sortable: false, filter: false, resizable: false }
          ];
