		...
		forkJoin(this.refsetService.getVersionStatuses(), this.refsetService.getVersions(), this.refsetService.getEditions(), this.refsetService.getOrganizations()).
            subscribe({next: ([results, versionResults, editionResults, organizationResults]) => {
                ...
                this.columnDefs = [
                    ...
                    { field: 'editionName', tooltipField: 'editionName', headerName: 'Edition/Extension', cellClass: 'refset-tool-directory-column-edition', minWidth: 140, resizable: false, valueGetter: this.editionValueGetter, cellRenderer: 'templateRenderer', cellRendererParams: { template: this.editionSection }, floatingFilterComponent: 'categoryFilterComponent',
                floatingFilterComponentParams: {suppressFilterButton: true, names: editionsArray}},
                    { field: 'organizationName', tooltipField: 'organizationName', headerName: 'Organization/Owner', cellClass: 'refset-tool-directory-column-organization', minWidth: 180, resizable: false, floatingFilterComponent: 'categoryFilterComponent',
                ...
                floatingFilterComponentParams: {suppressFilterButton: true, names: versionsArray}},
                    ...
                    { field: 'downloadable', tooltipField: 'downloadable', colId: 'actions', headerName: '', minwidth: 60,maxWidth:60, cellClass: 'refset-tool-directory-column-actions', cellRenderer: 'templateRenderer', cellRendererParams: { template: this.actionSection }, filter: false, pinned: 'right', resizable: false}
                ];
