    ...
    ngAfterViewInit() {
		...
		forkJoin(this.refsetService.getVersionStatuses(), this.refsetService.getVersions(), this.refsetService.getEditions(), this.refsetService.getOrganizations()).
            subscribe({next: ([results, versionResults, editionResults, organizationResults]) => {
                ...
                this.columnDefs = [
                    { field: 'id', tooltipField: 'id', colId: 'information', headerName: '',maxWidth: 65,minWidth: 65, width: 65, cellClass: 'refset-tool-directory-column-information', cellRenderer: 'templateRenderer', cellRendererParams: { template: this.infoSection }, filter: false, pinned: 'left', resizable: false},
                    { field: 'refsetId', tooltipField: 'refsetId', headerName: 'Refset ID', cellClass: 'refset-tool-directory-column-id', flex: 1, minWidth: 155,width:155},
                ...
                floatingFilterComponentParams: {suppressFilterButton: true, names: versionsArray}},
                    { field: 'modified', tooltipField: 'modified', headerName: 'Last Modified Date', cellClass: 'refset-tool-directory-column-modified-date', flex: 1, minWidth: 165, valueGetter: UiUtility.gridDateValueGetter, floatingFilterComponent: 'dateTextFilterComponent',
                    floatingFilterComponentParams: {suppressFilterButton: true}},
                    { field: 'downloadable', tooltipField: 'downloadable', colId: 'actions', headerName: '', minwidth: 70,maxWidth:70, cellClass: 'refset-tool-directory-column-actions', cellRenderer: 'templateRenderer', cellRendererParams: { template: this.actionSection }, filter: false, pinned: 'right', resizable: false}
                ];
