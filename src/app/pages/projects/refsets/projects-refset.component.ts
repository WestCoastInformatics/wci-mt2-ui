...
export class ProjectsRefsetComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
        ...
        this.refsetService.getVersions().subscribe((versionResults) => {
            ...
            this.columnDefs = [
                { field: 'refsetId', headerName: 'Reference Set ID', cellClass: 'refset-tool-directory-column-id', minWidth: 155, resizable: false, unSortIcon: true },
                { field: 'name', headerName: 'Reference Set Name', cellClass: 'refset-tool-directory-column-name', flex: 1, minWidth: 550, resizable: true, cellRenderer: 'templateRenderer', cellRendererParams: { template: this.nameSection }, unSortIcon: true },
