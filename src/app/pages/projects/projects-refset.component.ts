...
export class ProjectsRefsetComponent implements OnInit, AfterViewInit {
    ...
    ngAfterViewInit() {
	    ...
	    this.columnDefs = [
            ...
            { field: 'versionDate', headerName: 'Last Published Date', cellClass: 'refset-tool-directory-column-modified-date', flex: 1, minWidth: 180, valueGetter: UiUtility.gridDateValueGetter },
