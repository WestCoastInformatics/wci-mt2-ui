    ...
    ngAfterViewInit() {
        ...
        forkJoin(this.refsetService.getProjects('limit=500&offset=0&sort=name&sortAscending=true'), this.refsetService.getVersions()).subscribe(([projectResults, versionResults]) => {
            ...
            this.columnDefs = [
                ...
                { field: 'workflowStatus', headerName: 'Workflow Status', cellClass: 'refset-tool-directory-column-workflow-status', flex: 1, minWidth: 150,maxWidth:150, cellRenderer: 'templateRenderer', cellRendererParams: { template: this.workflowStatus }, 
                ...
                { field: 'versionDate', tooltipField: 'versionDate', headerName: 'Version Date', cellClass: 'refset-tool-directory-column-version-date', flex: 1, minWidth: 140,maxWidth:140, valueGetter: UiUtility.gridDateValueGetter, 
                ...
                { field: 'modified', tooltipField: 'modified', headerName: 'Last Modified Date', cellClass: 'refset-tool-directory-column-modified-date', flex: 1, minWidth: 165,maxWidth:165, valueGetter: UiUtility.gridDateValueGetter, 
