...
export class OrganizationsService extends RestService {
	...
	addUsers(organizationId: any, emails: any): Observable<any> {
		const self = this;
		return this.post(this.contextPath + 'organization/' + organizationId + '/user?emails=' + emails, '', false, function (err) {
